...
//        }
//
//        if (com.arasthel.swissknife.utils.AnnotationUtils.doesClassImplementInterface(annotatedFieldClassNode,
//                android.os.Parcelable) ||
//                hasParcelableAnnotation(realClassNode))
//            method = "Parcelable" + method
//        else if (!method && com.arasthel.swissknife.utils.AnnotationUtils.doesClassImplementInterface(annotatedFieldClassNode,
