...
//import app.Injector;
//import app.Utils;
//import app.events.access_point.MusicStationStateEvent;
...
//
//import static app.events.access_point.MusicStationStateEvent.State.CHANGING;
//import static app.events.access_point.MusicStationStateEvent.State.DISABLED;
//import static app.events.access_point.MusicStationStateEvent.State.ENABLED;
//
//@CompileStatic
...
//            super.onPreExecute();
//
//            bus.post(new MusicStationStateEvent(CHANGING));
//
//        }
//
//        @Override
...
//
//            bus.post(new MusicStationStateEvent(mMode? ENABLED : DISABLED));
//
//        }
//    }
//
